...
var data = __assign({ banks: [], branches: [] }, bank_data_json_1.default);
/**
...
var BankDataSource = /** @class */ (function () {
     ...
     */
    BankDataSource.prototype.fetchNewDataFromIsraelBank = function () {
        return __awaiter(this, void 0, void 0, function () {
            var csv, _a, banks, branches;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, functions_1.fetchCSVFromIsraelBank)()];
                    case 1:
                        csv = _b.sent();
